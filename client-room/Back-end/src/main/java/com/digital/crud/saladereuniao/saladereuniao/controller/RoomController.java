...
public class RoomController {
   ...
   @GetMapping("/rooms/{id}")
    ...
    public ResponseEntity<Room> updateRoom(@PathVariable(value = "id") long roomId, @Valid @RequestBody Room roomDetails) throws ResourceNotFoundException {
        ...
        roomDetails.setName(roomDetails.getName());
        roomDetails.setData(roomDetails.getData());
        roomDetails.setStarHour(roomDetails.getStarHour());
        roomDetails.setEndHour(roomDetails.getEndHour());
